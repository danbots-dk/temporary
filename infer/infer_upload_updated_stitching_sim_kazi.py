...
from updated_stitching_pairwise import full_registration
...
def infer_upload_stitching_simulation_updated(*, upload_model_id, wrap_model, depth_model, lum_model, opa_model, batch_name,
    ...
    try:
        ...
        for i in range(len(point_cloud_files)):
            pcd = o3d.io.read_point_cloud(point_cloud_files[i])
            pcds.append(pcd)
        
        pose_graph = full_registration(pcds, voxel_size, step_size=5, additional_voxel_size=voxel_size)
